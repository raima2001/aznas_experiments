...
echo "==============================================="
echo " AZ-NAS FAST-FULL SETUP & RUN (~20 min)"
echo "==============================================="
...
# -------- 6. Run all experiments in FAST-FULL mode --------
echo
echo "==============================================="
echo " RUNNING FAST-FULL PIPELINE (~20 min total)"
echo "==============================================="

echo
echo "[1/3] Running 9_aznas_loss_c100.py --fast_full ..."
python 9_aznas_loss_c100.py --fast_full

echo
echo "[2/3] Running 9_aznas_component_ablation.py --fast_full ..."
python 9_aznas_component_ablation.py --fast_full

echo
echo "[3/3] Running 9_aznas_overfitting_test.py --fast_full ..."
python 9_aznas_overfitting_test.py --fast_full

echo
echo "==============================================="
echo " FAST-FULL PIPELINE COMPLETE"
